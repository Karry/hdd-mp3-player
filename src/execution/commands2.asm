...
PRIKAZ_03h						; 03h – nastav oddil
	...
	; zálohujeme si důležité hodnoty do bufferu 1
	INDF_BANK_3
	movlw 0x90
	movwf FSR
	movfw POCATEK_DAT1
...
PRIKAZ_03h_NACTENO
	...
	btfss PREH_STAV0,7				; 7. bit = 1 => po načtení oddílu se začne přehrávat mp3, kterou se při posledním přehráváni skončilo 
...
PRIKAZ_03h_NENACTENO
	; pokud nebyla FATka úspěšně načtena, vrátíme zpět zálohované hodnoty...
	INDF_BANK_3
	movlw 0x90
	movwf FSR
	movfw INDF
...
; ! PODPROGRAM NETESTUJE ZDA NEBYLO ZADANO VETSI CISLO NEZ JE POCET CLUSTERU !!!
	...
	return
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
PRIKAZ_0Ch						; 0Ch – najdi záznam o tomto adresáři v nadřazeném adresáři
	movfw 0x078					; prvni byte zasobniku prikazu
	sublw h'0C'					
	btfss STATUS,Z
...
PRIKAZ_0Dh_KONEC
	...
	return
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
PRIKAZ_85h						; 85h – nastav předvolený „ekvalizér“
	movfw 0x078					; prvni byte zasobniku prikazu
	sublw h'85'					
	btfss STATUS,Z
	return						; nebyl prijat prikaz 0Dh
...
PRIKAZ_85h_KONEC
	...
	return
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
PRIKAZ_86h						; 86h – vrať nastavenou hlasitost
	movfw 0x078					; prvni byte zasobniku prikazu
	sublw h'86'
	btfss STATUS,Z
	...
	return
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
PRIKAZ_87h						; 87h – ulož nastavení přehrávání do EEPROM
	movfw 0x078					; prvni byte zasobniku prikazu
	sublw h'87'
	btfss STATUS,Z
