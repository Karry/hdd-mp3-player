...
#IF SPI_SOFTWARE==1
	...
	movwf SSPBUF		; dame dato do SPI bufferu
	nop
	nop
	nop
	nop
	...
	nop
	bcf MP3_BSYNC
	btfss PIR1,SSPIF	; 3. bit
	goto $-1			; cekame dokud neni prenos kompletni
	bcf PIR1,SSPIF		; 
	return
#ELSE
...
; pri praci pouziva TEMP1, TEMP2, TEMP3, TEMPW
	...
	call DELAY_5us		; pozor, prepise TEMP1
	bsf MP3_CS
	return
;**********************************************************
; do TEMP1 dame adresu registru 
...
VS_SOFT_RESET	; provede softwarovy reset dekoderu (pri zapnuti a pote po skonceni kazde mp3)
	...
	movlw 0x00
	movwf TEMP3
	call VS_WR_REG				; nastavime pouzivany filter
	...
	clrf TEMP2	
	clrf TEMP3
	call VS_WR_REG				; pokud je filter 0, vypneme plugin
	return
;**********************************************************
VS_SEND_32_NULL
...
VS_INIT
	...
	movlw .3
	movwf TEMP5
	call VS_SOFT_RESET_NO_PLUG		; resetujeme
