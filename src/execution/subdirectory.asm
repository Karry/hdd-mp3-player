...
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
; Tady ta část kódu má jeden jediný smysl. A to aby nalezla další adresář, který se má přehrávat pokud v aktuálním 
; adresáři již není žádná MP3, která nebyla přehrána. 
; 
; máme-li následující adresářovou strukruru:
; ROOT
;  | skladba_01.mp3
;  | skladba_02.mp3
;  +- DIRECTORY_1
...
;     | skladba_06.mp3
;
; Tak sou mp3 přehrávany v pořadí, jak je zobrazeno. Nejdříve všechny mp3 v ROOT (skladba_01,02) poté DIRECTORY_1...
; XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
