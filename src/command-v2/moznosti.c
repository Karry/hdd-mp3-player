...
void moznosti (void){
	...
	if (Flags.Bit.ZmenaObrazovky){
		...
		radek=0;
		sloupec=8;
		str2ram (StringBuffer, "MOŽNOSTI PØ.:");
	...
	if (ZmenaPolozky==1){
		if (PolozkaMenu==1 || PolozkaMenu==2){
			str2ram(StringBuffer, "\x11zpìt\x12  \x12  \x12  \x12zmìnit\x13");
		}else{
		...
		radek=3;
		sloupec=2;		
		str2ram (StringBuffer, " zvýraznìní basù   \x15 ");
		...
		radek=4;
		sloupec=2;		
		str2ram (StringBuffer, " pøehrávat po zap. \x15 ");
		...
		radek=5;
		sloupec=2;		
		str2ram (StringBuffer, " režim pøehrávání    ");
...
////////////////////////////////////////////////////////////////////////
char desitky(unsigned char Hodnota,unsigned char nula){
	// vratí èíslici jako ASCII znak, která na pozici desítek... Pokud je nula, tak vrátí znak definovaný v nula
...
////////////////////////////////////////////////////////////////////////
void NastavRezimPrehravani(void){
 	// RezimPrehravani - 0=prohledávání, hrát porád dál; 1=pøehrát složku; 2=repeat složky; 3=pøehrát jednu; 4=repeat souboru	
 	...
 	if (RezimPrehravani==1){							//  1=pøehrát složku
		PREHSTAV0.Bit.NeprehravatDal=0;
		PREHSTAV0.Bit.Repeat=0;
		//PREHSTAV0.Bit.RepeatSouboru=0;
 	...
 	if (RezimPrehravani==3){							// 3=pøehrát jednu
