...
void Prehravani(void){
  ...
  LbaPrehrAdresare[3]=RdUsart();
	...
	if (Flags.Bit.ZmenaObrazovky || PREHSTAV0.Bit.ZmenenSoubor ){
		// pokud se změnila obrazovka, nebo pokud se právě automaticky změnil přehrávaný soubor, 
		// načteme si jméno přehrávaného souboru a adresáře pro zobrazování na lcd...
