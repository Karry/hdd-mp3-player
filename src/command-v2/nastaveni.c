...
void nastaveni(void){
	...
	if (ZmenaPolozky==1){
		...
		// VypinatDisk => po jaké době nečinosti (minuty) se má vypínat disk
		// (5,10,15,30,60,nikdy)
		...
		// unsigned int ZtlumitPodsvetleni=5;	// po jaké době bez stisku klávesy ztlumit podsvětlení 
...
////////////////////////////////////////////////////////////////////////
void NastavDobuDoStandBy(void){
	// VypinatDisk - po jaké době nečinosti (minuty) se má vypínat disk (5,10,15,30,60,nikdy)
	unsigned char a,b;
	WrUsart(0x0D);
